...
# [Procdump](https://learn.microsoft.com/en-us/sysinternals/downloads/procdump) - dump process's memory. Could contain passwords 
PS C:\Users\offsec> procdump.exe
```